...
export default function About() {
  return (
    ...
    >
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 lg:px-8 grid grid-cols-1 lg:grid-cols-[1fr_380px_1fr] relative z-10">
        {/* --- KOLOM 1: TEKS KIRI --- */}
        <div className="flex flex-col items-end text-right pr-4 lg:pr-8 pt-4 lg:pt-28">
        ...
        <div
          className={`
          relative flex justify-center w-full min-h-[500px] lg:min-h-[700px] z-30
          -mt-8 lg:-mt-[8vh]            
          lg:-translate-x-[50px]        
        `}
        >
        ...
        <div className="flex flex-col items-start text-left pl-4 lg:pl-8 pt-4 lg:pt-28">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-12 h-[3px] bg-emerald-500"></div>
            <h2 className="text-zinc-500 tracking-[0.2em] text-sm uppercase font-black">
              Transformasi
